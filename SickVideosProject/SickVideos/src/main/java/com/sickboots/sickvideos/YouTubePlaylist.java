...
import com.sickboots.sickvideos.GoogleAccount;
...
public class YouTubePlaylist implements GoogleAccount.GoogleAccountDelegate, YouTubeFragment.YouTubeListProvider {
  ...
  private class YouTubePlaylistTask extends AsyncTask<GoogleAccountCredential, Void, List<Map>> {
    ...
    protected void onPostExecute(List<Map> result) {
      listener.onResults(com.sickboots.sickvideos.YouTubePlaylist.this.listener, result);
    }
